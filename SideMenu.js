...
export class SideMenu extends Component {
	...
	return(
      ...
      <TouchableOpacity onPress={() => Actions.reset('map')}>
        <Text style={styles.menuLink}>
            <FontAwesome>{Icons.compass}</FontAwesome> Map
        </Text>
      </TouchableOpacity>
      <TouchableOpacity>
        <Text style={styles.menuLink} onPress={() => Actions.reset('account')}>
            <FontAwesome>{Icons.user}</FontAwesome> Settings
        </Text>
      </TouchableOpacity>
      <TouchableOpacity onPress={() => Actions.reset('modal')}>
        <Text style={styles.menuLink}>
            <FontAwesome>{Icons.calendar}</FontAwesome> Calendar
        </Text>
      </TouchableOpacity>
      <TouchableOpacity onPress={() => Actions.reset('history')}>
        <Text style={styles.menuLink}>
